...
func (fake *FakeGithub) ListPullRequests(arg1 []githubv4.PullRequestState, arg2 resource.Page) ([]*resource.PullRequest, error) {
...
func (fake *FakeGithub) ListPullRequestsCalls(stub func([]githubv4.PullRequestState, resource.Page) ([]*resource.PullRequest, error)) {
	fake.listPullRequestsMutex.Lock()
